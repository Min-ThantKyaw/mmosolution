		...
		<>
			...
			>
				...
				<div
					...
					<h1 className="font-serif text-3xl font-bold mb-2 text-center">OSolutions.</h1>
					<p className="text-center text-brand-text/70 mb-8 font-sans">Sign up to access more features.</p>
					...
					<p className="text-center text-sm text-brand-text/80 mt-8 font-sans">
						...
						<button onClick={() => onModeChange('login')} className="font-semibold text-brand-text hover:text-brand-green transition-colors">SignIn</button>
					</p>
				</div>
			</div>
		</>
