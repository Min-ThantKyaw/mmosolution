		...
		<>
			<nav className="sticky top-0 bg-brand-bg z-50 border-b border-brand h-16 flex items-center justify-between px-4 lg:px-6">
				...
				<div className="flex items-center gap-4 flex-1">
					...
					<button id="mobileMenuBtn" className="text-brand-text hover:text-brand-green transition-colors focus:outline-none">
					...
					<div className="hidden md:flex relative ml-4 max-w-sm w-full">
						<div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
							<svg className="h-4 w-4 text-brand-text/50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
