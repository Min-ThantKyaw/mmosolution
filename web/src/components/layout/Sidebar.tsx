...
const Sidebar = () => { 
	...
	return (
		<>
			<div id="sidebarOverlay" className="fixed inset-0 bg-brand-text/20 backdrop-blur-sm z-40 hidden lg:hidden"></div>

		<aside id="sidebar" className="w-64 border-r border-brand bg-brand-bg fixed inset-y-0 left-0 z-40 pt-16 lg:pt-0 lg:static lg:block transform -translate-x-full lg:translate-x-0 sidebar-transition h-screen lg:h-[calc(100vh-4rem)] flex flex-col">
			<div className="flex-1 overflow-y-auto py-6 px-4">
				<ul className="space-y-1">
					...
					<li>
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path></svg>
							Library
						</Link>
					</li>
